...
lessThan(QT_MAJOR_VERSION, 5) {
	macx: error(PSPE requires Qt5 for OS X but $$[QT_VERSION] was detected.)
	else:lessThan(QT_MINOR_VERSION, 7): error(PSPE requires Qt 4.7 or newer but Qt $$[QT_VERSION] was detected.)
}
...
mobile_platform {
	...
	# Translations
	TRANSLATIONS = $$files($$P/Qt/languages/PSPE_*.ts)
