...
int alloc_device_open(hw_module_t const *module, const char *name, hw_device_t **device);
 ...
 int alloc_device_close(struct hw_device_t *device);
 int alloc_device_alloc(alloc_device_t *dev, int w, int h, int format, int usage, buffer_handle_t *pHandle, int *pStride);
 int alloc_device_free(alloc_device_t *dev, buffer_handle_t handle);
