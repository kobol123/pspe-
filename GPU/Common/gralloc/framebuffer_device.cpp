...
int init_frame_buffer_locked(struct private_module_t *module)
{
    ...
    int n1 = 0;
    int n2 = 0;
    if (g_Config.iMaliHackCompressb == 0){n=2;}else if (g_Config.iMaliHackCompressb == 1){n=4;}else if (g_Config.iMaliHackCompressb == 2){n=8;}
#ifdef GRALLOC_16_BITS
	/*
	 * Explicitly request 5/6/5
	 */
	info.bits_per_pixel = 16/n;
	info.red.offset     = 11;
	info.red.length     = 5;
	info.green.offset   = 5;
	info.green.length   = 6;
    ...
    if (g_Config.iMaliHackPixelb == 0){n1=4096;}else if (g_Config.iMaliHackPixelb == 1){n1=8188;}else if (g_Config.iMaliHackPixelb == 2){n1=16376;}else if (g_Config.iMaliHackPixelb == 3){n1=32752;}else if (g_Config.iMaliHackPixelb == 4){n1=65504;}else if (g_Config.iMaliHackPixelb == 5){n1=131008;}else if (g_Config.iMaliHackPixelb == 6){n1=262016;}else if (g_Config.iMaliHackPixelb == 7){n1=524032;}else if (g_Config.iMaliHackPixelb == 8){n1=1048064;}else if (g_Config.iMaliHackPixelb == 9){n1=2096128;}
    
    int refreshRate = 0;
    
    info.pixclock = n1 * 1000 * 1000;
    ...
    if (g_Config.iMaliHackBufferb == 0){n2=2;}else if (g_Config.iMaliHackBufferb == 1){n2=4;}else if (g_Config.iMaliHackBufferb == 2){n2=8;}else if (g_Config.iMaliHackBufferb == 3){n2=16;}
    

	/*
	 * map the framebuffer
	 */
	size_t fbSize = round_up_to_page_size(finfo.line_length/n2 * info.yres_virtual/n2);
...
int init_frame_buffer(struct private_module_t *module)
{
