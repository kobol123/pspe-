...
int PSPNetconfDialog::Update(int animSpeed) {
	...
	if (status == SCE_UTILITY_STATUS_INITIALIZE) {
		...
		PPGeDrawTextWrapped(err->T("PPSSPPDoesNotSupportInternet", "PSPe+ currently does not support connecting to the Internet for DLC, PSN, or game updates."), 241, 132, WRAP_WIDTH, PPGE_ALIGN_CENTER, 0.5f, CalcFadedColor(0xFFFFFFFF));
